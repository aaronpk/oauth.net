...
$languages['elixir'] = [
  ...
  'server_libraries' => [
    ...
    '<a href="https://gitlab.com/patatoid/boruta_auth">Boruta OAuth 2.0 provider</a>: Core of an OAuth provider giving business logic of authorization in order to setup an OAuth 2.0 server.'
  ],
];
