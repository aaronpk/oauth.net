...
<div class="container">
  <div>
    ...
    <?php if(time() < strtotime('2020-04-30')): ?>
    <div style="margin-top: 10px;">
      <iframe width="100%" height="440" src="https://www.youtube.com/embed/aU9RsE4fcRM" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
    </div>
    <?php endif ?>
