...
<?php require('../includes/_nav_primary.php'); ?>
    ...
    <div id="main" class="column first last span-18 prepend-1 append-1">
	  ...
	  <a href="https://www.manning.com/books/oauth-2-in-action"><img src="oauth_in_action.png" alt="OAuth in Action Cover" title="OAuth in Action" style="float:left;"></a>
			<p><i>OAuth 2 in Action</i> by Justin Richer and Antonio Sanso covers the OAuth 2 protocol in depth, providing hands-on exercises for building clients, authorization servers, and protected resources in various configurations. The book covers the structure and components of an OAuth 2 system as well as several protocols that are built on and around OAuth 2.</p>
